...
the workflow setups' steps can be used for running any small-to-medium-scale mlproject. Only commands that need to be changed are the git URI:s and in the scp command the '\*.gz' part that specifies the files to copy. 
